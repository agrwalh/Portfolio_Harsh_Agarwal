  ...
  return (
    <section id="home" className="w-full pt-32 pb-20 md:pt-48 md:pb-32">
      <div className="max-w-3xl">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-7xl font-headline animate-fade-in-up [animation-delay:300ms]">
          Harsh Agarwal.
        </h1>
        <h2 className="mt-3 text-3xl font-bold tracking-tight text-muted-foreground sm:text-5xl font-headline animate-fade-in-up [animation-delay:400ms]">
